...
//   if (err) {
//     // Manejar el error al conectar a la base de datos
...
//     if (err) {
//       // Manejar el error al obtener los pacientes
...
//     });
//   } catch (err) {
//     // Manejar el error al subir la foto a S3
//     console.error('Error al subir la foto a S3: ', err);
//     return;
//   }
// });

// app.post('/pacientes/:id/eliminar', (req, res) => {
